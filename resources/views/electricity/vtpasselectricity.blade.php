...
<div class="card shadow mb-4">
   ...
   <h6 class="m-0 font-weight-bold text-success" style="display:flex;align-items:center;justify-content:space-between;"><span>VTPASS Electricity</span></h6>
   </div>
       ...
       <div class="card-body">
           <div class="card-body">
               ...
               @endif
               @if(count($vtpass_electricity) == 0)
               <strong class="text-danger">No Electricity transaction yet</strong>
           ...
           <tbody>
               @foreach($vtpass_electricity as $charge)
