                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title"><span>Suspended Agents</span></h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title" style="display:flex;align-items:center;justify-content:space-between;"><span>Suspended Agents Records</span>  <a href="{{route("admin.users.create")}}" class="btn btn-sm btn-success">Create Agent</a></h4>
                                     
                                    <p class="text-muted font-14" style="display:flex;align-items:center;justify-content:space-between;">
                                      <span> List of all Suspeneded agents registered with dropifypay</span>
                                            ...
                                            <table  class="table table-striped dt-responsive nowrap w-100">
                                                ...
                                                <tbody id="tbody">
                                                    ...
                                                    <tr>
                                                       ...
                                                       <td>
                                                        <form method="post" action="{{url("/activateuser")}}">
                                                            @csrf
