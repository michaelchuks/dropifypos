                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title" style="display:flex;align-items:center;justify-content:space-between;"><span>Unactivated Agents Records</span>  <a href="{{route("admin.users.create")}}" class="btn btn-sm btn-success">Create Agent</a></h4>
                                            ...
                                            <table  class="table table-striped dt-responsive nowrap w-100">
                                                ...
                                                <tbody id="tbody">
                                                    ...
                                                    <tr>
                                                       ...
                                                       <td>
                                                           <a href="{{url("/serialnumber/$data->id")}}" class="btn btn-sm btn-success">Activate User</a>
                                                       </td>
                                                    </tr>
                                                    @endforeach
