                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title" style="display:flex;align-items:center;justify-content:space-between;"><span>New Agent</span> <a href="{{url("/agents")}}" class="btn btn-sm btn-success">Agents</a></h4>
                                            ...
                                            <form  method="post" action="{{route("admin.users.store")}}" enctype="multipart/form-data">
                                                ...
                                                <div class="row g-2">
                                                    ...
                                                    <div class="mb-3 col-md-6">
                                                        ...
                                                        <input type="NIN" name="NIN" value="{{old("NIN")}}" class="form-control" required placeholder="NIN" required />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="password" name="password" class="form-control" id="inputPassword4" placeholder="Password" required>
                                                          ...
                                                          <div class="mb-3">
                                                    <label for="inputAddress2" class="form-label">Pos Serial Number</label>
                                                    @error("pos_serial_number")<small><strong class="text-danger">{{$message}}</strong></small><br />@enderror
                                                    <input type="text" name="pos_serial_number" class="form-control" id="inputPassword4" placeholder="pos Serial Number" required>
                                                </div>

                                              

                                                <button type="submit" name="create_user_btn" class="btn btn-primary">Create Agent</button>
                                            </form>
                                        </div> <!-- end preview-->
