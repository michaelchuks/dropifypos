...
<div class="card shadow mb-4">
   ...
   <h6 class="m-0 font-weight-bold text-success" style="display:flex;align-items:center;justify-content:space-between;"><span>VTPASS Cable Subscription</span></h6>
   </div>
       ...
       <div class="card-body">
           <div class="card-body">
               ...
               @endif
               @if(count($vtpass_cable) == 0)
               <strong class="text-danger">No Cable subscription yet</strong>
           ...
           <tbody>
               @foreach($vtpass_cable as $charge)
